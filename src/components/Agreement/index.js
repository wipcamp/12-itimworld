            ...
            <div className="card text-white bg-secondary p-4 mt-4">
              <div className="element" id="containerElement">
                <Element name="box" onScroll={this.handleScroll} style={{position: 'relative', height: '40vh',overflow: 'scroll',fontSize:'0.9em'}}>
                  ...
                  <div style={{textIndent:'20px'}}>คุณสามารถใช้สิทธิที่คุณมีอยู่ตามกฎหมายคุ้มครองข้อมูลส่วนบุคคล ยังรวมถึงการเข้าถึง การแก้ไข การลบ ระงับการประมวลผลข้อมูล ขอให้โครงการส่งสำเนาข้อมูลส่วนบุคคลของคุณ ขอให้องค์กรคัดค้านการประมวลผลข้อมูล หรือถอนความยินยอม โครงการได้ทำการแต่งตั้งเจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล เพื่อกำกับดูแลคุ้มครองข้อมูลส่วนบุคคลของค่าย และคุณสามารถติดต่อผู้ดูแลข้อมูลของโครงการ ได้ที่อีเมล wipcamp@gmail.com</div>
                </Element>
              </div>
            </div>
