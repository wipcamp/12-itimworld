      ...
      <div className="container">
        <div className="card p-3" style={{opacity:'0.9',minHeight:'70vh'}}>
          <div className="card-body pb-0">
            ...
            <div style={{textIndent:'20px'}}>1. ผู้เข้าสมัครต้องเป็นผู้ที่กําลังศึกษาอยู่ชั้นมัธยมศึกษาปีที่ 3 - 6</div>
            ...
            <div style={{textIndent:'20px'}}>3. ผู้เข้าสมัครจะต้องไม่เป็นโรคที่อาจส่งผลกระทบต่อการดำเนินกิจกรรมของโครงการโดยรวม หรือเกินความสามารถของฝ่ายพยาบาลของโครงการในการดูแล ถ้าหากพบในภายหลัง ทางโครงการจำเป็นที่จะต้องตัดสิทธิ์ในการเข้าร่วมโครงการของผู้เข้าสมัคร</div>
            ...
            <div style={{textIndent:'20px'}}>3. ผู้เข้าสมัครสามารถทำการส่งใบสมัครได้ตั้งแต่วันที่ 19 กุมภาพันธ์ - 12 มีนาคม 2563 มิฉะนั้นจะถือว่าทำการสละสิทธิ์การเข้าร่วมโครงการ ค่ายเส้นทางสู่ฝันนักไอที ครั้งที่ 12</div>
