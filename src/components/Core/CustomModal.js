    ...
    <Modal isOpen={props.modal} toggle={props.toggle} >
      <div class="modal-content container">
        ...
        <div class="modal-body col-12">
          ...
          <ParagraphContext className="ml-4" style={{display:`${props.paragraphLink!==""?"":"none"}`}} >
            <a className="text-center" href={props.paragraphLink}>{linkName}</a>
          </ParagraphContext>
...
CustomModal.propTypes = {
  ...
  paragraphLink: PropTypes.string,
