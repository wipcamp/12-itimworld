          ...
          <Box className="container">
            {
              this.state.menu.map((data, i) => (
                <LinkStyle to={`/${data.link}`} className="text-center col-lg-3 col-md-3 col-sm-6 col-6 mb-5" key={i} style={{pointerEvents:`${ data.status && (data.message === 'คำถามสาขา' || data.message === 'คำถามทั่วไป' ) ? "none" : "auto" }`}}>
